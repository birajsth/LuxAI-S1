...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        self.team_sprit = self.all_args.team_sprit
        ...
        # agents
        self.playeragent.agent.set_policy(self.trainer.policy)

        # add agent to payoff
        self.payoff.add_player(self.playeragent)
